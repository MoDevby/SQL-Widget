...
namespace Sql_Widget.Helper
{
	...
	//				"SelectedItems", typeof(IList), typeof(AttachedProperties),
	//				new PropertyMetadata(null, SelectedItems_PropertyChanged));
	...
	//		{
	//			(coll as INotifyCollectionChanged).CollectionChanged += (s, e3) =>
	//			{
